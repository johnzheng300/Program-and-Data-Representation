...
* @return this has no return because it is a constructor
* @param xsize The size of the graph in x direction
* @param ysize The size of the grapph in y direction
* @param num_cities The number of cities
* @param seed Fixes the sequence of the random number generator
* @todo Need to write test for constructor
*/
...
* @return nothing returns because it is an destructor
* @todo test if the destructor efficiently deallocates memory
*/
...
* @return This is a void function, nothing returns
* @todo test cases for the correct print
*/
...
* @return this is a void function, nothing returns
* @todo Need to test for correct format
*/
...
* @param city1 The location of city 1
* @param city2 The location of city 2
* @return Return a floating point value of the distance
*/
...
* @param length The length of the trip
