		...
		for (int j = 0; j < cols; j++) {
			for (int dir = 0; dir < 8; dir++) {
				for (int len = 3; len < 23; len++) {
					word = getWordInGrid(i, j, dir, len, rows, cols);
					if (!prefix.contains(word)) {
						break;
					}
					if (h.contains(word) && word.length() == len) {
						switch (dir) {
							case 0:
								//cout << "N (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("N (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 1:
								//cout << "NE (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("NE (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 2:
								//cout << "E (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("E (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 3:
								//cout << "SE (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("SE (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 4:
								//cout << "S (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("S (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 5:
								//cout << "SW (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("SW (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 6:
								//cout << "W (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("W (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
							case 7:
								//cout << "NW (" << i << ", " << j << "):       " << getWordInGrid(i, j, dir, len, rows, cols) << endl;
								wordsInGrid.push_back("NW (" + to_string(i) + ", " + to_string(j) + "):       " + getWordInGrid(i, j, dir, len, rows, cols));
								wordsFound += 1;	
								break;
						}
					}
