...
//default constructor
Hash::Hash() {
	//make time worse: 19.39 seconds
	//tableSize = getNextPrime(10);
	//original: 7.3 seconds
	tableSize = getNextPrime(3000);
